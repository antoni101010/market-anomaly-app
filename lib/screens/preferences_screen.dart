...
class _PreferencesScreenState extends State<PreferencesScreen> {
        ...
        children: [
          ...
          if (_preferences.simpleMode) ...[
            ...
            _dropdown(
              ...
              value: _simpleAnomalyLevel(_preferences.minAnomaly),
              items: const {
                'normal': 'Normale',
                'strong': 'Forte',
  ...
  String _simpleAnomalyLevel(double value) {
    if (value >= 60) return 'very_strong';
